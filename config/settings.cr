...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Crystal Todo web application."
  #
  #
  ...
  #
  # settings.secret_key_base= jeqbxrt5p79mGBxNlsALtk3ta_a6V3PzismkPiEoxwQ
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("crystal-todo.log", "w"))
  #
  #
end
